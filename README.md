...
**Response**: Returns a success message and the created debt details if successful.
...
**Response**: Returns a JSON array containing the debts that match the specified status.
